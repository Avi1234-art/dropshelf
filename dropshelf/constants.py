...
FOLDER_PANEL_WIDTH = 200
FOLDER_ITEM_HEIGHT = 72
FOLDER_PANEL_PADDING = 8
FOLDER_PANEL_ITEM_GAP = 4
FOLDER_ADD_BUTTON_HEIGHT = 64
FOLDER_TAB_VISIBLE_WIDTH = 28
FOLDER_TAB_DOCK_OVERLAP = 6
FOLDER_TAB_HEIGHT = 50
FOLDER_PANEL_MIN_HEIGHT = (
    SHELF_HEADER_HEIGHT + FOLDER_ADD_BUTTON_HEIGHT + FOLDER_PANEL_PADDING * 3
)
